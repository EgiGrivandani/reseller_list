		...
		<div class="card-content">
			<div class="card-body">
				<form class="form form-vertical" id="formInput" enctype="multipart/form-data">
					<input type="hidden" name="idInput" value="<?=$list->id?>">
					<div class="form-body">
						<div class="row">
							<div class="col-12">
								<div class="form-group mandatory">
									<label for="flName" class="form-label">Name</label>
									<input type="text" id="flName" class="form-control" name="fname" placeholder="name ads" value="<?=$list->name?>">
								</div>
							</div>
							<div class="col-12">
...
<script>
	...
	$('#formInput').submit(function(e) {
		...
		$.ajax({
			url: base_url + 'Admin/bannerAjax_put',
			type: 'post',
			dataType: 'json',
			data: formData,
			contentType: false,
